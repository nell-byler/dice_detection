...
6. I downloaded the pre-trained model from [](). [*5min*] *Note - I later went back and spent much more time researching the best model for my particular application*
   - I chose to use ssd_mobilenet_v1_fpn_shared_box_predictor_640x640_coco14_sync_2018_07_03. I wanted higher accuracy classifications and wanted to use larger input images. For mobile device object detection, you need to use an SSD model, and for taking advantage of GCS TPU resources, you will need a TPU compatible model (this model does both - for more information see [here](https://github.com/tensorflow/models/blob/master/research/object_detection/g3doc/tpu_compatibility.md)).
   - I put the downloaded model in `models/ssd_mobilenet_XX`.
...
```
In the `train_input_reader` section:
```
...
### Creating a container image "prepped" for object detection
